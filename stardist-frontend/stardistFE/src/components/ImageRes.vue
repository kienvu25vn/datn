    ...
    <div class="result">
        ...
        <div class="roi-manager">
            ...
            <div class="roi-points">
                <div v-for="(item, index) in this.points" class="point" :class="this.pointClicked[index] && 'bg-green'"
            ...
            <div class="roi-extension">
                <div class="roi-box">
                    ...
                    <div class="">
                        <span>Distance Map</span>
                        <input type="checkbox" v-model="distanceMap" :disabled="labelAll" @click="handleShowDistanceMap">
                    </div>
                </div>
            </div>
            <!-- <canvas ref="can" style="width: 400px;height: 215px; background-color: #fff;"></canvas> -->
